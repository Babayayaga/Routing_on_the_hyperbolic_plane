...
## The applet
The applet visualizes the routing on the hyperbolic plane and should be self-explanatory (hopefully). It's possible to create own routing scenarios by inserting points and polygons. A use without the applet is established in the `experiments.cpp` file.
